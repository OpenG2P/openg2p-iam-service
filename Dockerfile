...
RUN python3 -m pip install \
  ...
  git+https://github.com/psnappz/openg2p-g2pconnect-common-lib@1.1#subdirectory=openg2p-g2pconnect-common-lib \
  git+https://github.com/psnappz/openg2p-g2pconnect-common-lib@1.1#subdirectory=openg2p-g2pconnect-mapper-lib \
  ./src
