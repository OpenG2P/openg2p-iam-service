...
from openg2p_iam_core.services import auth_transaction_store
from openg2p_iam_core.user_auth.auth import AuthFactory
from openg2p_iam_core.user_auth.dependencies import JwtBearerAuth
...
class BaseAuthController(BaseController):
    ...
    async def get_user_profile(
        ...
        claim_user_type = claims.get("user_type") or claims.get("userType")
        if self.user_type and claim_user_type != self.user_type:
